...
function sociable_init_locale(){
	...
	$mofile = dirname(__FILE__) . '/i18n/sociable-' . get_locale() . '.mo';
	load_textdomain('sociable', $mofile);
}
add_action('admin_init', 'sociable_init_locale');
...
$sociable_known_sites = Array(
    ...
    'Memori.ru' => Array(
        ...
        'description' => 'Memori.ru',
    	'spriteCoordinates' => Array(73,91),
    ),
	'МоёМесто.ru' => Array(
        'favicon' => 'moemesto.png',
        'url' => 'http://moemesto.ru/post.php?url=PERMALINK&amp;title=TITLE&amp;desc=EXCERPT',
        'description' => 'МоёМесто.ru',
    	'spriteCoordinates' => Array(91,91),
    ),
	'Сто закладок' => Array(
        'favicon' => '100zak.png',
        'url' => 'http://www.100zakladok.ru/save/?bmurl=PERMALINK&amp;bmtitle=TITLE',
        'description' => 'Сто закладок',
    	'spriteCoordinates' => Array(109,91),
    ),
	'MisterWong.RU' => Array(
		'favicon' => 'misterwong.png',
...
function sociable_admin_menu() {
	...
	add_options_page('Sociable RE', '<img src="'.$sociableicon.'" style="position: relative; top: 3px;" /> Sociable RE', 8, 'Sociable', 'sociable_submenu');
}
...
<div class="wrap">
	<?php screen_icon(); ?>
	<h2><?php _e("Sociable RE Options", 'sociable'); ?></h2>
	...
	<tr>
		...
		<td>
			...
			<?php _e("(automatically disables sprite usage)", "sociable"); ?>
		</td>
	</tr>
	<tr>
		<th scope="row" valign="top">
...
<h3><?php _e('Like this plugin?','sociable'); ?></h3>
...
<ul class="sociablemenu">
	...
	<li><?php _e('Donate','sociable'); ?> <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=NRYHZVJNPGGA6">Paypal</a>, <a href="wmk:payto?Purse=R214581684777&Amount=10&Desc=%D0%9F%D0%BE%D0%B4%D0%B4%D0%B5%D1%80%D0%B6%D0%BA%D0%B0%20%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D0%B8%20%D0%BF%D0%BB%D0%B0%D0%B3%D0%B8%D0%BD%D0%B0%20VKontakte-Share-Button&BringToFront=Y">Webmoney</a>, <a href="https://money.yandex.ru/donate.xml?to=41001198774354&s5=hand">Яндекс.Деньги</a></li>
</ul>
<h3><?php _e('Need support?','sociable'); ?></h3>
<p><?php _e('If you have any problems or good ideas, please talk about them in the <a href="http://wordpress.org/tags/sociable-re">Support forums</a> or <a href="http://www.jackyfox.com/sociable-re/">plugin page</a>.', 'sociable'); ?></p>

<h3><?php _e('Credits','sociable'); ?></h3>
<p><?php _e('<a href="http://www.jackyfox.com/sociable-re/">Sociable</a> was originally developed by <a href="http://push.cx/">Peter Harkins</a> and was been maintained by <a href="http://yoast.com/">Joost de Valk</a> since the beginning of 2008. On September of 2009, the new home of Sociable is <a href="http://blogplay.com">BlogPlay.com</a>. It\'s released under the GNU GPL version 2. On June of 2010, new version is released in russian by <a href="http://www.jackyfox.com/">Eugene Padlov</a>.','sociable'); ?></p>
